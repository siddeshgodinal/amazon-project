...
public class AmazonAuto {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//input[@id='ap_email']")).sendKeys("Enter your email here");
		driver.findElement(By.xpath("//input[@id='continue']")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//input[@id='ap_password']")).sendKeys("Enter your password here");
